...
def create_pdf_article():
    ...
    img1_path = '../downloads/images/5193621219/video_game_east_1.jpg'
    if os.path.exists(img1_path):
        pdf.add_image(img1_path, 'Пример пасхалки в видеоигре')
...
Ищите, исследуйте и находите — ведь настоящая магия игр часто прячется там, где её меньше всего ждут."""
    ...
    img_last_path = '../downloads/images/5193621219/video_game_east_4.jpg'
    if os.path.exists(img_last_path):
        pdf.add_image(img_last_path, 'Мир игровых секретов ждёт своих исследователей')
